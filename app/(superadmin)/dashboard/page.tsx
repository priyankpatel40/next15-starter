    ...
    <section className="h-full px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto w-full">
        ...
        <Card className="mb-8 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
          ...
          <div className="h-80">
            <Suspense key={dailyActiveCompanies.length} fallback={<p> {t('loading')}</p>}>
        ...
        <Card className="mb-8 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
          ...
          <div className="h-80">
            <Suspense key={dailyActiveUsers.length} fallback={<p> {t('loading')}</p>}>
        ...
        <Card className="mb-8 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
          ...
          <div className="h-80">
            <Suspense key={dailyLoginActivity.length} fallback={<p> {t('loading')}</p>}>
