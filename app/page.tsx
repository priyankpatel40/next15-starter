...
export default function Web() {
  return (
    <div className="dark:bg-gray-900">
      <section className="animate__animated animate__fadeIn bg-[#fafafa] bg-custom-bg bg-contain bg-right-top bg-no-repeat pb-14 transition duration-500 ease-in-out dark:from-gray-800 dark:to-gray-600">
        ...
        <div className="w-1/2 px-4 py-8 text-left lg:py-16">
          <div className="mx-auto place-self-start">
            <h1 className="animate__animated animate__fadeIn mb-4 text-5xl font-extrabold leading-tight tracking-tight text-black dark:text-black md:text-5xl xl:text-6xl">
              Next.js Enterprise Starter Kit
            </h1>

            <h2 className="mb-6 p-4 text-left text-3xl font-extrabold text-black dark:text-black">
              Launch Your Enterprise Product{' '}
              <span className="animate-pulse-glow rounded-md bg-gradient-to-r from-orange-500 to-pink-500 px-3 py-2 text-white">
                In Hours
              </span>{' '}
              with Next.js Starter Kits
            </h2>

            <p className="mb-6 max-w-lg text-left text-lg text-black dark:text-black">
